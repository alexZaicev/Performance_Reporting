...
class RGConfirmDialog(RGDialogBase):
    ...
    def __init__(self, message=None, p_text=None, n_text=None, p_callback=None, n_callback=None, **kwargs):
        ...
        self.widgets = [
            ...
            RGButton(config=self.config, text=n_text, custom_pack=True, callback=n_callback,
                     width=self.dimensions[0] * 0.02, height=self.dimensions[1] * 0.005, rel_x=0.3, rel_y=0.8),
            RGButton(config=self.config, text=p_text, custom_pack=True, callback=p_callback,
                     width=self.dimensions[0] * 0.02, height=self.dimensions[1] * 0.005, rel_x=0.7, rel_y=0.8)
        ]