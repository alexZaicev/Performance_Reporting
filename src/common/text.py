...
SCHOOLS_IN_DEFICIT_REPORTED_QUARTERLY = 'Schools in deficit (reported quarterly)'
...
CPM_MEASURES_TO_EXCLUDE = 'CPM measures to exclude'
GENERATE = 'Generate'
CANCEL = 'Cancel'
ERROR = 'Error'
CURRENT_FISCAL_YEAR_IS_NOT_SELECTED = 'Current fiscal year is not selected'
CURRENT_FISCAL_MONTH_IS_NOT_SELECTED = 'Current fiscal month is not selected'
TEMPLATE_ROOT_DIRECTORY_PATH_IS_NOT_PROVIDED = 'Template root directory is not provided'
REPORT_OUTPUT_DIRECTORY_IS_NOT_PROVIDED = 'Report output directory is not provided'
OK = 'OK'
CONTINUE = 'Continue'
ABORT = 'Abort'
